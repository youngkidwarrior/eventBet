(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("drizzle-react"), require("react"), require("prop-types"));
	else if(typeof define === 'function' && define.amd)
		define(["drizzle-react", "react", "prop-types"], factory);
	else if(typeof exports === 'object')
		exports["drizzle-react-components"] = factory(require("drizzle-react"), require("react"), require("prop-types"));
	else
		root["drizzle-react-components"] = factory(root["drizzle-react"], root["react"], root["prop-types"]);
...
var _drizzleReact = __webpack_require__(0);
...
var ContractData = function (_Component) {
  ...
  function ContractData(props, context) {
    var _this$contracts$_this;
    ...
    _this.dataKey = (_this$contracts$_this = _this.contracts[_this.props.contract].methods[_this.props.method]).cacheCall.apply(_this$contracts$_this, _toConsumableArray(methodArgs));
  ...
  _createClass(ContractData, [{
    ...
    value: function render() {
      ...
      if (typeof displayData === 'array') {
        var displayListItems = displayData.map(function (datum, index) {
          _react2.default.createElement(
            'li',
            { key: index },
            datum,
      ...
      if ((typeof displayData === 'undefined' ? 'undefined' : _typeof(displayData)) === 'object') {
        var i = 0;
        var displayObjectProps = [];

        Object.keys(displayData).forEach(function (key) {
          if (i != key) {
            displayObjectProps.push(_react2.default.createElement(
              'li',
              { key: i },
              _react2.default.createElement(
                'strong',
...
exports.default = (0, _drizzleReact.drizzleConnect)(ContractData, mapStateToProps);
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                ' Please check and make sure Metamask or you browser are pointed at the correct network and your account is unlocked.'
              )
            )
          )
        );
